...
module SwarmSDK
  class AgentDefinitionExtraTest < Minitest::Test
    ...
    def test_memory_enabled_with_nil
      agent_def = Agent::Definition.new(
        :test_agent,
        {
          description: "Test agent",
      ...
      refute_predicate(agent_def, :memory_enabled?)
    end

    def test_memory_enabled_with_hash_and_directory
      agent_def = Agent::Definition.new(
        :test_agent,
        {
          description: "Test agent",
    ...
    def test_memory_enabled_with_hash_and_string_key
      agent_def = Agent::Definition.new(
        :test_agent,
        {
          description: "Test agent",
    ...
    def test_memory_enabled_with_empty_directory
      agent_def = Agent::Definition.new(
        :test_agent,
        {
          description: "Test agent",
    ...
    def test_memory_enabled_with_whitespace_directory
      agent_def = Agent::Definition.new(
        :test_agent,
        {
          description: "Test agent",
    ...
    def test_memory_enabled_with_memory_config_object
      # Create a mock MemoryConfig object
      memory_config = Object.new
      def memory_config.directory = "/tmp/memory"
      def memory_config.adapter = :faiss
    ...
    def test_memory_enabled_with_disabled_memory_config
